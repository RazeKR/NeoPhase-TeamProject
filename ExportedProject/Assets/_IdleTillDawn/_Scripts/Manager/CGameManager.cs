...
public class CGameManager : MonoBehaviour
{
    ...
    /// </summary>
    public CStageData CurrentStageData => _allStageData[currentStageIndex]; // 현재 스테이지 데이터
    ...
    public void LoadProgress() =>
        currentStageIndex = PlayerPrefs.GetInt("StageIndex", 0); // 없으면 처음부터
    ...
    private void LoadNextWorld(int currentWorld)
    {
        ...
        {
            Debug.Log("[CGameManager] 모든 월드 클리어 — 엔딩 씬 처리 필요"); // TODO: 엔딩 씬 연결
            return;
        }
